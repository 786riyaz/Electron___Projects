 ...
 * Project File Merger
 * -------------------
 * Scans the entire project directory recursively and merges all files into "Public Application Complete Code.txt"
 *
...
const OUTPUT_FILE = path.join(ROOT_DIR, "Tracker Application Complete Code.txt");

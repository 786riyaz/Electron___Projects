// src/activityConfig.js

// CATEGORY VISUAL META (icon + color)
...
export const DEFAULT_DAILY = {
  ...
  // 6:30 – 9:30 AM Personal Development Block
  ...
  // Flexible Learning — often coding → Programming
  ...
  // Maghrib + Evening Creativity
  "Maghrib Salah": { time: "19:30", category: "Salah" },

  // Creative problem solving = Personal Development → Learning category
  "Creative Problem Solving / Reading": {
    time: "19:50",
    category: "Learning",
  },
...
export const DEFAULT_WEEKLY = {
  ...
  "Aptitude Tests + Speaking Practice": {
    category: "Aptitude",
    days: ["Thu"],
  },
  ...
  "Habit Tracking Review": {
    category: "Reflection / Night",
    days: ["Sun"],
  },
  "Diverse Content (Podcast / Book)": {
    category: "Learning",
    days: ["Sun"],
  },
  "Networking / Developer Community": {
    category: "Work",
    days: ["Sun"],
  },
  
  "Sunday Habit Tracking (8:00 AM)": {
    category: "Reflection / Night",
    days: ["Sun"],
  },
  "Weekly Diverse Content (8:15 AM Block)": {
    category: "Learning",
    days: ["Sun"],
  },
  "Sunday Networking (8:30 PM)": {
    category: "Work",
    days: ["Sun"],
  },
};
